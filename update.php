...
if(isset($_GET['updatenbr'])){
 ...
 include 'connection.php';
    ...
    SET username=$username, phone=$phonenumber, dob=$dateofbirth WHERE userid='$id'";
    ...
    <div class="page-container">
        ...
        <aside class="sidebar-left">
            ...
            <nav class="main-nav">
                ...
                <a href="#" class="nav-item"><i class="fas fa-hashtag"></i> Explore users</a>
        ...
        <main class="main-content">
            ...
            <div class="post-card" >
                <!-- <div style="display:flex; padding-bottom: 10px;">
                    ...
                    <span style="font-weight: 700;">The TouchlineX</span>
                    <span style="color: var(--color-text-gray); margin-left: 5px;">@touchlinex · 1/h</span>
                </div>
                <p style="margin-left: 25px;">OFFICIAL: The CAF Goalkeeper of the Year is....</p>
                <p style="margin-left: 25px; margin-bottom: 10px;">Yassine Bounou 🧤🏆</p>
                <div style="margin-left: 25px; background-color: #333; height: 300px; border-radius: 16px;">
                    </div> -->
 ...
 <form action="" method="POST">
    ...
    ?>
        ...
        <div class="form-group">
            <input type="text" class="input-field" placeholder="Name" name="uname" value="<?php echo $username; ?>">
        </div>

        <div class="form-group">
            <input type="text" class="input-field" placeholder="Phone" name="phone" value="<?php echo $phonenumber; ?>">
